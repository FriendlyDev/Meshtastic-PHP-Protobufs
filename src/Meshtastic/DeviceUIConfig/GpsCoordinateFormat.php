...
namespace Meshtastic\DeviceUIConfig;
...
class GpsCoordinateFormat
{
     ...
     *
     * Generated from protobuf enum <code>MLS = 6;</code>
     */
    const MLS = 6;
...
class_alias(GpsCoordinateFormat::class, \Meshtastic\DeviceUIConfig_GpsCoordinateFormat::class);

 ...
 *
 * Generated from protobuf message <code>meshtastic.ModuleConfig.AudioConfig</code>
 */
class AudioConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.meshtastic.ModuleConfig.AudioConfig.Audio_Baud bitrate = 3;</code>
     */
    protected $bitrate = 0;
    /**
     * I2S Word Select
    ...
    {
        GPBUtil::checkEnum($var, \Meshtastic\ModuleConfig\AudioConfig\Audio_Baud::class);
        $this->bitrate = $var;
...
class_alias(AudioConfig::class, \Meshtastic\ModuleConfig_AudioConfig::class);

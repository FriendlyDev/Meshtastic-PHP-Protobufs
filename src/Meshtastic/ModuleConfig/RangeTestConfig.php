 ...
 *
 * Generated from protobuf message <code>meshtastic.ModuleConfig.RangeTestConfig</code>
 */
...
class_alias(RangeTestConfig::class, \Meshtastic\ModuleConfig_RangeTestConfig::class);

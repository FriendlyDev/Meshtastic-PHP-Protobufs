 ...
 * Lora Config
 *
 * Generated from protobuf message <code>meshtastic.Config.LoRaConfig</code>
 */
class LoRaConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.meshtastic.Config.LoRaConfig.ModemPreset modem_preset = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.meshtastic.Config.LoRaConfig.RegionCode region = 7;</code>
     */
    protected $region = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>bool sx126x_rx_boosted_gain = 13;</code>
     */
    protected $sx126x_rx_boosted_gain = false;
    /**
     ...
     *
     * Generated from protobuf field <code>float override_frequency = 14;</code>
     */
     ...
     *           the local regulations if you're not a HAM.
     *           Has no effect if the duty cycle of the used region is 100%.
     *     @type bool $sx126x_rx_boosted_gain
     *           If true, sets RX boosted gain mode on SX126X based radios
     *     @type float $override_frequency
     *           This parameter is for advanced users and licensed HAM radio operators.
     *           Ignore Channel Calculation and use this frequency instead. The frequency_offset
     *           will still be applied. This will allow you to use out-of-band frequencies.
     *           Please respect your local laws and regulations. If you are a HAM, make sure you
     ...
     * @return bool
     */
    public function getSx126XRxBoostedGain()
    {
        return $this->sx126x_rx_boosted_gain;
    }
     ...
     * @return $this
     */
    public function setSx126XRxBoostedGain($var)
    {
        GPBUtil::checkBool($var);
        $this->sx126x_rx_boosted_gain = $var;
     ...
     * @return float
     */
    public function getOverrideFrequency()
    {
        return $this->override_frequency;
    }
     ...
     * @return $this
     */
    public function setOverrideFrequency($var)
    {
        GPBUtil::checkFloat($var);
     ...
     * @return bool
     */
    public function getIgnoreMqtt()
    {
        return $this->ignore_mqtt;
    }
     ...
     * @return $this
     */
    public function setIgnoreMqtt($var)
    {
        GPBUtil::checkBool($var);
...
class_alias(LoRaConfig::class, \Meshtastic\Config_LoRaConfig::class);

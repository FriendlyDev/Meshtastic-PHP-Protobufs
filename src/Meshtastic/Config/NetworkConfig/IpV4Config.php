...
/**
 * Generated from protobuf message <code>meshtastic.Config.NetworkConfig.IpV4Config</code>
 */
...
class_alias(IpV4Config::class, \Meshtastic\Config_NetworkConfig_IpV4Config::class);

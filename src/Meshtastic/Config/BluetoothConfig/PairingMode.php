...
namespace Meshtastic\Config\BluetoothConfig;

use UnexpectedValueException;

/**
 * Protobuf type <code>meshtastic.Config.BluetoothConfig.PairingMode</code>
 */
class PairingMode
{
    /**
...
class_alias(PairingMode::class, \Meshtastic\Config_BluetoothConfig_PairingMode::class);

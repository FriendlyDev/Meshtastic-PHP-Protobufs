 ...
 *
 * Protobuf type <code>meshtastic.Config.DisplayConfig.GpsCoordinateFormat</code>
 */
...
class_alias(GpsCoordinateFormat::class, \Meshtastic\Config_DisplayConfig_GpsCoordinateFormat::class);

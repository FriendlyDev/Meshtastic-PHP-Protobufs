 ...
 *
 * Protobuf type <code>meshtastic.Config.PositionConfig.PositionFlags</code>
 */
class PositionFlags
{
    /**
...
class_alias(PositionFlags::class, \Meshtastic\Config_PositionConfig_PositionFlags::class);

...
class Position extends \Google\Protobuf\Internal\Message
{
     ...
     * TODO: REPLACE
     *
     * Generated from protobuf field <code>.meshtastic.Position.AltSource altitude_source = 6;</code>
     */
     ...
     *
     * Generated from protobuf field <code>uint32 precision_bits = 23;</code>
     */
    protected $precision_bits = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Meshtastic\Position\AltSource::class);
     ...
     * @return int
     */
    public function getPrecisionBits()
    {
        return $this->precision_bits;
    }
     ...
     * @return $this
     */
    public function setPrecisionBits($var)
    {
        GPBUtil::checkUint32($var);
        $this->precision_bits = $var;
